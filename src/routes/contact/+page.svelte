...
<svelte:head>
	...
	<meta name="twitter:url" content="https://risingsunsolar.in/contact" />
	<meta name="twitter:title" content="Contact Us | Rising Sun Solar Systems" />
	<meta
		...
		<Card class="border-none bg-transparent shadow-none">
			...
			<CardContent class="space-y-4">
				...
				<div class="flex items-center gap-4 rounded-xl bg-white p-3">
					<div class="w-fit rounded-md bg-buttons-muted p-3">
						<Phone class="h-6 w-6 text-text-green" />
					</div>
					<div>
						<p class="text-sm font-semibold">Phone</p>
						<p class="text-sm text-muted-foreground">+91 94957 44899</p>
						<p class="text-sm text-muted-foreground">+91 94958 66099</p>
					</div>
				</div>

				<div class="flex items-center gap-4 rounded-xl bg-white p-3">
					<div class="w-fit rounded-md bg-buttons-muted p-3">
						<Mail class="h-6 w-6 text-text-green" />
					</div>
				...
				<div class="flex items-center gap-4 rounded-xl bg-white p-3">
					<div class="w-fit rounded-md bg-buttons-muted p-3">
						<MapPin class="h-6 w-6 text-text-green" />
					</div>

					<div>
						<p class="text-sm font-semibold">Address</p>
						<p class="text-sm text-muted-foreground">
							Central Junction, Ayarkunnam, Kottayam, Kerala 686564
						</p>
					</div>
				</div>
				...
				<div class="flex items-center gap-4 rounded-xl bg-white p-3">
					<div class="w-fit rounded-md bg-buttons-muted p-3">
						<Clock class="h-6 w-6 text-text-green" />
					</div>

					<div>
						<p class="text-sm font-semibold">Business Hours</p>
						<p class="text-sm text-muted-foreground">Mon – Fri: 9:00 AM – 8:00 PM</p>
						<p class="text-sm text-muted-foreground">Sat: 9:00 AM – 7:30 PM</p>
				...
				<div class="mt-8 rounded-2xl bg-[#25D366]/32 p-5">
					...
					<a
						href="https://wa.me/919495744899?text=Hello%2C%20I'd%20like%20to%20get%20in%20touch%20with%20RisingSun%20experts."
						target="_blank"
						rel="noopener noreferrer"
					>
						<Button
							class="hover:bg-buttons-green border border-buttons-whatsapp bg-buttons-whatsapp text-sm font-semibold "
						>
							<svg
				...
				<div class="pt-4">
					...
					<div class="flex gap-3">
						<a
							...
							href="https://www.facebook.com/risingsunfancylightshop/"
							target="_blank"
							rel="noopener noreferrer"
							aria-label="Facebook"
						>
			...
			<CardContent class="space-y-8">
				...
				<div class="overflow-hidden rounded-2xl border">
					<iframe
						...
						src="https://www.google.com/maps?q=Rising%20Sun%20Solar%20Systems%20Ayarkunnam&output=embed"
					>
					</iframe>
				</div>

				<!-- Showroom -->
				<div class="rounded-xl bg-buttons-muted p-4">
					<h4 class="mb-1 font-semibold">Visit Our Showroom</h4>
					<p class="text-sm text-muted-foreground">
						Come see our products in person! Our showroom features working displays of solar
						systems, security equipment, and automation solutions. No appointment necessary during
						business hours.
					</p>
				</div>
			</CardContent>
